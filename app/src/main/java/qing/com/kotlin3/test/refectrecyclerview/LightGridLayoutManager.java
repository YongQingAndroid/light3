 ...
 */
public class LightGridLayoutManager extends LightLinearLayoutManager {

    private static final boolean DEBUG = false;
    private static final String TAG = "LightGridLayoutManager";
     ...
     */
    public LightGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                                  int defStyleRes) {
    ...
    /**
     * Creates a vertical LightGridLayoutManager
     *
     * @param context   Current context, will be used to access resources.
     * @param spanCount The number of columns in the grid
     */
    public LightGridLayoutManager(Context context, int spanCount) {
        super(context);
     ...
     */
    public LightGridLayoutManager(Context context, int spanCount, int orientation,
    ...
    /**
     * stackFromEnd is not supported by LightGridLayoutManager. Consider using
    ...
    public void setStackFromEnd(boolean stackFromEnd) {
        if (stackFromEnd) {
            throw new UnsupportedOperationException(
                    "LightGridLayoutManager does not support stack from end."
    ...
    /**
     * Returns the current {@link SpanSizeLookup} used by the LightGridLayoutManager.
     *
     * @return The current {@link SpanSizeLookup} used by the LightGridLayoutManager.
     */
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        while (count < mSpanCount && layoutState.hasMore(state) && remainingSpan > 0) {
            ...
            if (spanSize > mSpanCount) {
                throw new IllegalArgumentException("Item at position " + pos + " requires " +
                        spanSize + " spans but LightGridLayoutManager has only " + mSpanCount
                        + " spans.");
            }
            remainingSpan -= spanSize;
            if (remainingSpan < 0) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (mOrientationHelper.getDecoratedMeasurement(view) != maxSize) {
                final LayoutParams lp = (LayoutParams) view.getLayoutParams();
                final Rect decorInsets = RefectRecyclerView.getmDecorInsets(lp);
    ...
    private void measureChildWithDecorationsAndMargin(View child, int widthSpec, int heightSpec,
        ...
        if (alreadyMeasured) {
            measure = RefectRecyclerView.shouldMeasure(this, "shouldReMeasureChild", child, widthSpec, heightSpec, lp);
        } else {
            measure = RefectRecyclerView.shouldMeasure(this, "shouldMeasureChild", child, widthSpec, heightSpec, lp);
        }
        if (measure) {
     ...
     *
     * @see LightGridLayoutManager#setSpanSizeLookup(SpanSizeLookup)
     */
    public static abstract class SpanSizeLookup {
        ...
        /**
         * Clears the span index cache. LightGridLayoutManager automatically calls this method when
         ...
         * {@link #getSpanSize(int)}. LightGridLayoutManager does not call this method for
    ...
    /**
     * LayoutParams used by LightGridLayoutManager.
     * <p>
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
         ...
         * even if the layout is RTL. In a vertical LightGridLayoutManager, <b>leftmost</b> span is span
