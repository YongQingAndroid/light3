...
public class LightLinearLayoutManager extends RecyclerView.LayoutManager implements
    ...
    public RecyclerView.LayoutManager setRecyclerView(RecyclerView recyclerView) {
     ...
     * helps {@link LightLinearLayoutManager} make those decisions.
    ...
    /**
     * Creates a vertical LightLinearLayoutManager
     *
     * @param context Current context, will be used to access resources.
     */
    public LightLinearLayoutManager(Context context) {
     ...
     */
    public LightLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
     ...
     */
    public LightLinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                                    int defStyleRes) {
    ...
    private void layoutForPredictiveAnimations(RecyclerView.Recycler recycler,
        ...
        for (int i = 0; i < scrapSize; i++) {
            ...
            if (RefectRecyclerView.scrapIsRemoved(scrap)) {
                continue;
            }
     ...
     * <code>4</code> to this method for each inner RecyclerView's LightLinearLayoutManager will enable
...
//        }
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec) {
        ...
        /**
         * 补偿shouldMeasureTwice
         */
//        RefectRecyclerView.setMeasuredDimensionFromChildren(this, widthSpec, heightSpec);
//        setMeasureSpecs(
...
//        }
    ...
    // overridden by LightGridLayoutManager
