...
public class LightRichBubbleRadioButton extends RadioButton {
    ...
    public LightRichBubbleRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
//        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.richBubbleText);
//        bg_color = a.getColor(R.styleable.richBubbleText_bubble_color_bg, Color.TRANSPARENT);
//        bg_press_color = a.getColor(R.styleable.richBubbleText_bubble_press_bg_color, bg_color);
//        bg_active_color = a.getColor(R.styleable.richBubbleText_bubble_active_bg_color, bg_color);
//
//        bg_drawable = a.getDrawable(R.styleable.richBubbleText_bubble_drawable_bg);
//        bg_press_drawable = a.getDrawable(R.styleable.richBubbleText_bubble_press_bg_drawable);
//        bg_active_drawable = a.getDrawable(R.styleable.richBubbleText_bubble_active_bg_drawable);
//
//        text_color = a.getColor(R.styleable.richBubbleText_bubble_text_color, Color.BLACK);
//        text_press_color = a.getColor(R.styleable.richBubbleText_bubble_press_text_color, text_color);
//        text_active_color = a.getColor(R.styleable.richBubbleText_bubble_active_text_color, text_color);
//
//        float radio = a.getDimension(R.styleable.richBubbleText_bubble_radio, 0f);
//        radio_left_top = a.getDimension(R.styleable.richBubbleText_bubble_radio_left_top, radio);
//        radio_left_bottom = a.getDimension(R.styleable.richBubbleText_bubble_radio_left_bottom, radio);
//        radio_right_top = a.getDimension(R.styleable.richBubbleText_bubble_radio_right_top, radio);
//        radio_right_bottom = a.getDimension(R.styleable.richBubbleText_bubble_radio_right_bottom, radio);
//
//        isstock = a.getBoolean(R.styleable.richBubbleText_bubble_stock, false);
//        isdotted_line = a.getBoolean(R.styleable.richBubbleText_bubble_dotted_line, false);
//        a.recycle();
        init();
    ...
    public void setAllTextColor(int allTextColor) {
        text_color = allTextColor;
        text_press_color = allTextColor;
        text_active_color = allTextColor;
    }

    public void setAllBgColor(int allBgColor) {
        bg_color = allBgColor;
        bg_press_color = allBgColor;
        bg_active_color = allBgColor;
    }

    public LightRichBubbleRadioButton(Context context) {
        super(context);
    }
